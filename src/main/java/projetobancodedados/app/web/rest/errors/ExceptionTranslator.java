package projetobancodedados.app.web.rest.errors;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof projetobancodedados.app.service.EmailAlreadyUsedException ||
            ex instanceof projetobancodedados.app.service.UsernameAlreadyUsedException
        ) {
        ...
        if (
            ex instanceof projetobancodedados.app.service.InvalidPasswordException
