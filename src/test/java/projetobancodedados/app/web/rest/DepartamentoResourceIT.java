...
class DepartamentoResourceIT {
    ...
    public static Departamento createEntity(EntityManager em) {
        Departamento departamento = new Departamento().codigo(DEFAULT_CODIGO).nome(DEFAULT_NOME);
        return departamento;
    }
    ...
    public static Departamento createUpdatedEntity(EntityManager em) {
        Departamento departamento = new Departamento().codigo(UPDATED_CODIGO).nome(UPDATED_NOME);
        return departamento;
    }
    ...
    void putExistingDepartamento() throws Exception {
        ...
        updatedDepartamento.codigo(UPDATED_CODIGO).nome(UPDATED_NOME);
    ...
    void fullUpdateDepartamentoWithPatch() throws Exception {
        ...
        partialUpdatedDepartamento.codigo(UPDATED_CODIGO).nome(UPDATED_NOME);
